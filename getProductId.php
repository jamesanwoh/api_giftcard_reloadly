 ...
 <div style="width:100%; visibility:hidden;">
     <div style=" ">
         <center>
               ...
               <div style="border:0px solid gray; border-radius:30px; width:80%;">
                   <b>
                        ...
                        <div class="modal-body">
                                <div style="border:1px solid gray; border-radius:40px;">   
                                    <div class="modal-header" >
                                        <h4 class="modal-title"><?=$productId->productName?></h4>
                                    </div>
                                        <div>
                            ...
                            <form>
                                <div class="form-group">
                                    <h4 class="modal-title"><?=$productId->productId?></h4>
                                    <h4 class="modal-title"><?=$productId->productName?></h4>
                                    <h4 class="modal-title"><?=$productId->brand->brandName?></h4>
                                    <h4 class="modal-title"><?=$productId->country->name?></h4>
